...
<div class="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
    ...
    <form action="{{ route('gallery.update', $image->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <input type="text" id="location" name="location" value="{{ old('location', $image->location) }}" class="mt-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500">
        </div>
